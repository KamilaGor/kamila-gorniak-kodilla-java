...
public class CheckersTestSuite {
	...
	public void testCheckersBuilder() {
		//Given
		Checkers checkers = new Checkers.CheckersBuilder()// początkowe ustawienie planszy *dwa pionki oraz jedna damka
				.PlayerOne("John")
				.PlayerTwo("Theresa")
		...
		//When - pobranie wartości 3 figur plus jedno pole bez pionka
